...
{
    /// <inheritdoc />
    public partial class InsertIdentityTablesWithIntPrimaryKey_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageRedirect = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefaultMenuId = table.Column<int>(type: "int", nullable: true),
