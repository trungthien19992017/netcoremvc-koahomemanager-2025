document.addEventListener("DOMContentLoaded", function() {
    let k = isRtl ? "rtl" : "ltr";
    {
        ...
        let l = document.getElementById("addEventBtn")
          , r = document.querySelector(".btn-delete-event")
          , d = document.querySelector(".btn-cancel")
          , i = document.getElementById("eventTitle")
        ...
        var D, P, M = Array.from(document.querySelectorAll(".input-filter")), q = document.querySelector(".inline-calendar");
        let g = {
            Business: "primary",
            Holiday: "success",
            Personal: "danger",
      ...
      ${e.text}
        ...
        function F() {
            var e = document.querySelector(".fc-sidebarToggle-button")
              , t = document.querySelector(".fc-prev-button")
              , n = document.querySelector(".fc-next-button")
              , a = document.querySelector(".fc-header-toolbar");
            for (t.classList.add("btn", "btn-sm", "btn-icon", "btn-outline-secondary", "me-2"),
            n.classList.add("btn", "btn-sm", "btn-icon", "btn-outline-secondary", "me-4"),
            a.classList.add("row-gap-4", "gap-2"),
            ...
            e.insertAdjacentHTML("beforeend", '<i class="icon-base ri ri-menu-line icon-24px text-body"></i>')
        }
        f.length && (select2Focus(f),
        f.select2({
        ...
        let S = new Calendar(w,{
            ...
            eventClick: function(e) {
                ...
                void 0 !== E.extendedProps.guests && b.val(E.extendedProps.guests).trigger("change"),
        ...
        function I() {
            ...
            u.value = "",
            m.checked = !1,
            b.val("").trigger("change"),
            v.value = ""
        }
        S.render(),
        F(),
        q = document.getElementById("eventForm"),
        FormValidation.formValidation(q, {
            fields: {
                eventTitle: {
                    validators: {
                        notEmpty: {
