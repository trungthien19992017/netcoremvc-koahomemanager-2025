...
namespace KOAHome.Services
{
  public interface IDashboardService
  {
    ...
    public Task<JsonObject> NET_DashboardConfig_Get(string dashboardCode);
    public Task<List<dynamic>> NET_DashboardConfig_ups(string code, long userId, JsonObject options, JsonArray widgets);
  ...
  public partial class DashboardService : IDashboardService
  {
    ...
    public async Task<JsonObject> NET_DashboardConfig_Get(string dashboardCode)
    {
    ...
    public async Task<List<dynamic>> NET_DashboardConfig_ups(string code, long userId, JsonObject options, JsonArray widgets)
    {
      string connectionString = _configuration.GetConnectionString("ConfigConnection");
